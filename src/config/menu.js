const MENUS = [
  { useInGallery: false, useInGlobalNav: false, color: '', name: 'Top', icon: 'mdi-home', path: '/', pageTitle: 'うちトレ', description: 'トップページに戻ります。' },
  ...
  { useInGallery: true, useInGlobalNav: true, color: '#64B5F6', name: '100マス計算（light）', icon: 'mdi-plus-minus-box', path: '/materials/box100light', description: 'たし算、ひき算、25マスだけでチャレンジ！' },
  ...
  { useInGallery: true, useInGlobalNav: true, color: '#26A69A', name: 'お問い合わせ', icon: 'mdi-account-box', path: '/contact', description: '何か気になることがあればこちらまで。' },
];
